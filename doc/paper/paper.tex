...
\subsubsection{Features}
\begin{Verbatim}[fontsize=\footnotesize]
    (A) Bool[holding-pet] [k=1]
    (B) Dist[cell-has-agent;adjacent_cell;cell-has-destination] [k=4]
    (C) Dist[cell-has-agent;adjacent_cell;cell-has-pet] [k=4]
\end{Verbatim}

\subsubsection{Feature Descrition}
$A$. The agent is holding the pet\\
$B$. Manhattan distance between agent and destination\\
$C$. Manhattan distance between agent and pet
